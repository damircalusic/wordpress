...
<body <?php body_class(); ?> itemscope itemtype="https://schema.org/LocalBusiness">
<div id="page" class="site">
<header id="masthead" class="site-header">
<nav id="site-navigation" class="main-navigation"><?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'huvud-meny-top', 'menu_class' => 'huvud-meny-top', 'container'  => '' ) ); ?></nav>
</header>
